...
unset($__errorArgs, $__bag); ?>" type="text" name="firstName" id="firstName" value="<?php echo e($user->firstname); ?>" placeholder="Enter First Name">
...
unset($__errorArgs, $__bag); ?>" type="text" name="lastName" id="lastName" value="<?php echo e($user->lastname); ?>" placeholder="Enter last Name">
...
unset($__errorArgs, $__bag); ?>" type="text" name="email" id="email" value="<?php echo e($user->email); ?>" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>" type="text" name="age" id="age" value="<?php echo e($user->age); ?>" placeholder="Enter Age">
                                <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select name="position" id="position" class="form-select">
                                <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($position->id); ?>" <?php echo e($employee->position_name == $position->name ? 'selected' : ''); ?>><?php echo e($position->code.' - '.$position->name); ?></option>
...
<?php /**PATH C:\Users\Lenovo\Documents\Semester 4\Laravel\modul5\resources\views/employee/edit.blade.php ENDPATH**/ ?>